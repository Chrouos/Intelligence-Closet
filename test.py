...
# 3-1. LowerClothesNodeService
# clothesNodeLowerService = ClothesNodeLowerService()
# print("最後一個位子:", clothesNodeLowerService.lastId())
# print(clothesNodeLowerService.queryAll())
# print(clothesNodeLowerService.queryById(2))
# print(clothesNodeLowerService.queryByPosition(2))
# clothesNodeLowerService.updatePositionToNull(5)
# clothesNode_create = '{ "Position": 5,"SubCategoryId": 5, "ColorId": 8, "UserPreferences": 7,  "UsageCounter":4, "CreateTime": "2020/01/01","ModifyTime": "2020/01/01", "FilePosition": "aaa", "IsFavorite": 0 }'
# print(clothesNodeLowerService.create(clothesNode_create))
# print(clothesNodeLowerService.deleteByPosition(0))

# 3-2. ClothesNodeUpperService
# clothesNodeUpperService = ClothesNodeUpperService()
# print("最後一個位子:", clothesNodeUpperService.lastId())
# print(clothesNodeUpperService.queryAll())
# print(clothesNodeUpperService.queryById(2))
# print(clothesNodeUpperService.queryByPosition(2))
# clothesNodeUpperService.updatePositionToNull(3)
# clothesNode_create = '{ "Position": 5,"SubCategoryId": 5, "ColorId": 8, "UserPreferences": 7,  "UsageCounter":4, "CreateTime": "2020/01/01","ModifyTime": "2020/01/01", "FilePosition": "aaa", "IsFavorite": 0 }'
# print(clothesNodeUpperService.create(clothesNode_create))
# print(clothesNodeUpperService.deleteByPosition(30))

# 3-3. OtherClothesNodeService
# clothesNodeOtherService = ClothesNodeOtherService()
# print(clothesNodeOtherService.queryAll())
# print(clothesNodeOtherService.queryById(2))
# print(clothesNodeOtherService.queryByPosition(2))
# clothesNodeOtherService.updatePositionToNull(3)
