...
class CrawlerStationController:
    ...
    def refreshAllData(self):
        self.refreshDataByNet()  # 各站
        
        self.allCity = self.getAllCity(); # 各 City名稱
        self.allInformation = self.getAllInformation()
        ...
        for outIndex in range(len(self.allInfo_dict)):
            stationService.create(self.allInfo_dict[outIndex])
            # print(self.allInfo_dict[outIndex])
